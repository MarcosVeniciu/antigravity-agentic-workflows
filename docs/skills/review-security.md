...
| **Cap. 6.11 & Apêndices** | **Code Crawling & Dangerous Sinks** | 🟢 **CONCLUÍDO** | Script nativo [`scan_sinks.py`](file:///e:/Codigos/antigravity-agentic-workflows/skills/review-security/scripts/scan_sinks.py) poliglota (Python, JS/TS, Dart) varrendo AST e regex por chamadas inseguras. |
