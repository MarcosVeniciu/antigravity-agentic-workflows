...
It reads the blood trail (Log/Traceback), searches the Vault (`03-pivots-and-bugs/`) for sibling problems from the past, and tries to draw the error's timeline.
...
The AI will always require the documentation of this new error in Obsidian or ask for the creation of a new integration test (E2E) to ensure that specific problem doesn't haunt the repository twice.
