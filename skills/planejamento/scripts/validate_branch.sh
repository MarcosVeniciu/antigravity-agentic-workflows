...
# Output Contract: 
#   - Exit 0: If branch is valid (e.g., feature/*, bugfix/*, refactor/*)
...
# Accepts patterns like: feature/name, bugfix/name, hotfix/name, refactor/name, chore/name
...
if [[ "$CURRENT_BRANCH" =~ $VALID_PATTERN ]]; then
    ...
    echo "ℹ️  Accepted patterns: feature/*, bugfix/*, hotfix/*, refactor/*, chore/*, docs/*, style/*, test/*"
    exit 1
fi