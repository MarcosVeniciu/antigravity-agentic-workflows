...
3. **Safe Mermaid Diagrams**: Every node label in Mermaid diagrams must be enclosed in double quotes (e.g., `A["Input"]`).
4. **Template Fidelity**: Local module documentation must adhere to the standardized sections in the template.
