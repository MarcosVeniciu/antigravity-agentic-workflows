...
Load detailed operational procedures on demand via `view_file` at `references/EXECUTION.md`:
* **Mode 1: Branch Validation & Git Flow Strategy:** Branch validation (`scripts/validate_branch.sh`) and working branch checkouts.
